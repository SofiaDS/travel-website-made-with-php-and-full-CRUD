...
<body>
    ...
    <main>
            <div class='addTripForm cardContainer'>
                <h3>Add trip to the list</h3>
            ...
            '<div class="container">
                <div class="travelCardsFlex">
                    ...
                    <div class="card">
                        ...
                        <form class="inline" method="post" action="update.php">
                            <input type="hidden" name="id" value=" '.$trip['id'].' ">
                            <input class="updateDel" type="submit" value="Update Trip">
                        </form>
                        <form class="inline" method="post" action="delete.php">
                            <input type="hidden" name="id" value=" '.$trip['id'].' ">
                            <input class="updateDel" type="submit" value="Delete Trip">
                        </form>
